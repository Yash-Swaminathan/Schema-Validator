import pytest
from intern_project.main import APP
...
def valid_config_data():
    ...
    """
    return {
        "name": "John Doe",       # Valid name: letters and space
        "age": 25,
        "email": "john@example.com",
        "is_active": True,
        "hobbies": "reading,swimming",
        "street": "123 Some St",
        "city": "London",         # Valid city: letters only
        "zip_code": "12345"
    }
...
def test_add_config_invalid_name(invalid_name_config_data):
    ...
    # Pydantic validation typically returns 422 Unprocessable Entity
...
def test_validate_yaml_valid():
    ...
    age: 25
    email: john@example.com
    """  # Minimal valid YAML for your schema
...
def test_validate_yaml_invalid():
    ...
    # Adjust based on your actual endpoint behavior.
    assert response.status_code == 200, response.text
    result = response.json()
